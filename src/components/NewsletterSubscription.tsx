...
const NewsletterSubscription = () => {
  ...
  return (
    <div className="flex w-full justify-center bg-shop-bg text-shop-text">
      <div className="flex w-full max-w-sm flex-col items-center justify-start gap-y-4 px-8 py-16 ">
